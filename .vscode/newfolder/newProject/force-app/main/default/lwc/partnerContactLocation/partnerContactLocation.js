...
import { loadScript, loadStyle } from 'lightning/platformResourceLoader'; // functions to load css and js from the downlode file
...
export default class PartnerContactLocation extends LightningElement {
    ...
    processOutput({data,error})
    {
        if(data)
        {
            ...
            this.lat = this.result.fields.Partner_Geo_Location__Latitude__s.value; //read value from field
